...
choices = ['台積電: 2022.1.1 至 2024.4.9','中興電:2022.1至2024.1' , '鴻海:2022.1至2024.1','緯穎:2022.1至2024.1','大台指期貨2024.12到期: 2023.12 至 2024.4.11', '小台指期貨2024.12到期: 2023.12 至 2024.4.11']
...
if choice == '小台指期貨2024.12到期: 2023.12 至 2024.4.11':
    ...
    end_date = st.text_input('輸入結束日期 (日期格式: 2024-04-11), 區間:2023-12-21 至 2024-04-11', '2024-04-11')
if choice == '中興電:2022.1至2024.1':
    start_date = st.text_input('輸入開始日期(日期格式: 2022-1-2), 區間:2022-01-02 至 2024-06-17', '2022-01-02')
    end_date = st.text_input('輸入結束日期 (日期格式: 2024-06-17), 區間:2022-1-2 至 2024-06-17', '2024-06-17')
if choice == '鴻海:2022.1至2024.1':
    start_date = st.text_input('輸入開始日期(日期格式: 2022-01-02), 區間:2022-01-02 至 2024-06-17', '2022-01-02')
    end_date = st.text_input('輸入結束日期 (日期格式: 2024-06-17), 區間:2022-01-02 至 2024-06-17', '2024-06-17')
if choice == '緯穎:2022.1至2024.1':
    start_date = st.text_input('輸入開始日期(日期格式: 2022-01-02), 區間:2022-01-02 至 2024-06-17', '2022-01-02')
    end_date = st.text_input('輸入結束日期 (日期格式: 2024-06-17), 區間:2022-01-02 至 2024-06-17', '2024-06-17')
